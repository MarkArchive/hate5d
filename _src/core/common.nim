...
# | License: LGPL 3.0                       |
# +=========================================+
import options, times, strutils, math, random, tables
import sdl2
...
var 
    randomInitialized {.global.} = false
    textureCache*: Table[string, SdlTexture]
...
proc fail*[T](err: string, val: T): HateResult[T] =
    return HateResult[T](
        ok: false,
        val: val,
        err: err
...
proc extractResult*[T](res: HateResult[T]): T =
    res.val