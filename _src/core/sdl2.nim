...
# mouse
proc sdlGetMouseState*(x, y: ptr int32): uint32
    {.importc: "SDL_GetMouseState", header: "<SDL2/SDL.h>".}

proc sdlGetGlobalMouseState*(x, y: ptr int32): uint32
    {.importc: "SDL_GetGlobalMouseState", header: "<SDL2/SDL.h>".}

# teclado
proc sdlGetKeyboardState*(numkeys: ptr int32): ptr uint8
    {.importc: "SDL_GetKeyboardState", header: "<SDL2/SDL.h>".}